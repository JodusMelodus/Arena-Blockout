execute as @e[type=minecraft:snowball] at @s run summon sulfur_cube ~ ~ ~ {Tags:["grenade"], Size:1, absorbed_block:{id:"minecraft:tnt"}, fuse:80,attributes:[{id:"minecraft:scale", base:0.15}, {id:"minecraft:movement_speed", base:0.0}]}
