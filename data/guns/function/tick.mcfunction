...
execute as @p at @s anchored eyes run summon minecraft:chicken ^ ^ ^0.3 {Tags:["shoot_temp"], NoGravity:1b,NoAI:1b, Invulnerable:1b,DeathTime:0,DeathLootTable:"", Team:"no_collision"}
